...
export const todos: Todo[] = [
    {
        ...
        description: 'Mempelajari konsep dasar Server Components pada Next.js dan perbedaannya dengan Clients Components.',
        completed: true,
    ...
    },
    {
        ...
        description: 'Menggunakaan directive "use client" untuk interaktivitas seperti form input, onClick handler, dan state.',
        completed: false,
        createdAt: '2026-08-22',
    },
];
